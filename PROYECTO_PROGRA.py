...
opgen = int(input(
    "Convertor de unidades e identifica si un número es primo o no B), "
    "selecciona una opcion:\n 1.Convertidor de unidades \n 2. Identificar"
    "si un número es primo\n 3.Calcular el promedio de una clase,"
...
while opgen == 1:
    ...
    opcion1 = float(input(
        "Selecciona una unidad de medida o de peso:"
    ...
    if opcion1 == 1:
        medida = float(input(
            "¿Qué unidad de medida deseas convertir? \n"
            "1.km \n 2.m \n 3.cm \n 4.mm \n"))
    ...
    #Hacer la conversión según la medida seleccionada...
        if medida == 1:
            ...
            print(f"El valor de la medida en metros es {m}, en milímetros"
            f"es {mm} y en centímetros es {cm} cm")
            ...
            mm = medida2 * 1000
            cm = medida2 * 100
            print(f"El valor de la medida en kilometros es {km}, en milímetros"
                f"es {mm} y en centímetros es {cm}")
            
        elif medida == 3:
            km = medida2 / 100000
            m = medida2 / 100
            mm = medida2 * 10
            print(f"El valor de la medida en kilometros es {km}, en metros es"
                f"{m} y en milímetros es {mm}")  
    ...
    #Ahora la conversión a unidades de medida de volumen (litros, mililitros, etc.)
        ...
        medida = float(input(
            "¿Qué unidad de volumen deseas convertir? \n 1.L" 
            "\n 2.ml \n 3.cl \n 4.dl \n"
            )
                             )
        ...
        if medida == 1:
            ...
            cl = medida2 * 100
            dl = medida2 * 10
            print(f"El valor del volumen en mililitros es {ml}, en centilitros"
                  f"es {cl} y en decilitros es {dl} dl")
            
        elif medida == 2:
            l = medida2 / 1000
            cl = medida2 / 10
            dl = medida2 / 100
            print(f"El valor del volumen en litros es {l}, en centilitros es"
                f"{cl} y en decilitros es {dl}")
            
        elif medida == 3:
            l = medida2 / 100
            ml = medida2 * 10
            dl = medida2 / 10
            print(f"El valor del volumen en litros es {l}, en mililitros es"
                f"{ml} y en decilitros es {dl}")
    ...
    # Ahora la conversión a unidades de peso (gramos, kilogramos, etc.)
        ...
        if medida == 1:
            ...
            mg = medida2 * 1000000
            t = medida2 / 1000
            print(f"El valor del peso en gramos es {g}, en miligramos es {mg}"
                  f" y en toneladas es {t} t")
            
        elif medida == 2:
            kg = medida2 / 1000
            mg = medida2 * 1000
            t = medida2 / 1000000
            print(f"El valor del peso en kilogramos es {kg}, en miligramos es {mg}"
                  f" y en toneladas es {t}")
            
        elif medida == 3:
            kg = medida2 / 1000000
            g = medida2 / 1000
            t = medida2 / 1000000000
            print(f"El valor del peso en kilogramos es {kg}, en gramos es"
                  f"{g} y en toneladas es {t}")
...
while opgen == 3:
    calificaciones = input("Ingrese la lista de promedios de los alumnos"
                        "(separados por comas): ")
    
    calificaciones = [int(x) for x in calificaciones.split(",")]

    alumno=[]

    while True:
        alumnoss=input("ingrese los nombres de tus alumnos (cuando termine de"
        "escribir un nombre, presione enter, escriba 'cancelar"
    ...
    if len(alumno) != len(calificaciones):
        print("Los datos no coinciden, por favor ingrese los datos "
            "nuevamente...")
